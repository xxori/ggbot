...
class EventHandler(discord.Cog):
    ...
    async def on_command_error(self, ctx: commands.Context, e):
        ...
        # permission errors
            ...
            await ctx.send(f':closed_lock_with_key: ``{ctx.command.name}`` can be executed only by server owner.')
        ...
        # uh oh something broke
            ...
            await ctx.send(":closed_lock_with_key: You have to be a club leader to run this command")
